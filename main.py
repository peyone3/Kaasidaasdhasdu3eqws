...
async def internal_course_type_selection(update: Update, context: CallbackContext) -> int:
    ...
    internal_questions_semester = {
        "ar": [
            ...
            ("IRAT1", "كم جبت في ال IRAT 1؟ (مثال: 8/10)"),
            ("TRAT1", "كم جبت في ال TRAT 1؟ (مثال: 49/50)"),
        ...
        "en": [
            ...
            ("IRAT1", "What did you score in IRAT 1? (e.g. 9/10)"),
            ("TRAT1", "What did you score in TRAT 1? (e.g. 48/50)"),
    ...
    internal_questions_semesterly = {
        "ar": [
            ...
            ("IRAT1", "كم جبت في ال IRAT 1؟ (مثال: 9/10)"),
            ("IRAT2", "كم جبت في ال IRAT 2؟ (مثال: 9/10)"),
            ("TRAT1", "كم جبت في ال TRAT 1؟ (مثال: 49/50)"),
            ("TRAT2", "كم جبت في ال TRAT 2؟ (مثال: 49/50)"),
        ...
        "en": [
            ...
            ("IRAT1", "What did you score in IRAT 1? (e.g. 9/10)"),
            ("IRAT2", "What did you score in IRAT 2? (e.g. 9/10)"),
            ("TRAT1", "What did you score in TRAT 1? (e.g. 49/50)"),
            ("TRAT2", "What did you score in TRAT 2? (e.g. 49/50)"),
